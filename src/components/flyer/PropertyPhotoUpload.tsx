    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      {photoUrl ? (
        ...
        <label className="block cursor-pointer">
          <div className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${uploading ? 'border-gray-300 bg-gray-50' : 'border-gray-300 hover:border-[#403e36]'}`}>
            {uploading ? (
              ...
              <>
                ...
                <p className="text-gray-600 font-medium">Click to upload property photo</p>
